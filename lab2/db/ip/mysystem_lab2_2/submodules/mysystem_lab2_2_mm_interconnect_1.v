// mysystem_lab2_2_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module mysystem_lab2_2_mm_interconnect_1 (
	...
	mysystem_lab2_2_mm_interconnect_1_router router (
	...
	mysystem_lab2_2_mm_interconnect_1_router router_001 (
	...
	mysystem_lab2_2_mm_interconnect_1_router_002 router_002 (
	...
	mysystem_lab2_2_mm_interconnect_1_router_002 router_003 (
	...
	mysystem_lab2_2_mm_interconnect_1_router_002 router_004 (
	...
	mysystem_lab2_2_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (sys_clk_sys_clk_clk),                                                 //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	mysystem_lab2_2_mm_interconnect_1_cmd_demux cmd_demux_001 (
		.clk                (sys_clk_sys_clk_clk),                                                 //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	mysystem_lab2_2_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mysystem_lab2_2_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mysystem_lab2_2_mm_interconnect_1_cmd_mux cmd_mux_002 (
		.clk                 (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mysystem_lab2_2_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mysystem_lab2_2_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mysystem_lab2_2_mm_interconnect_1_rsp_demux rsp_demux_002 (
		.clk                (sys_clk_sys_clk_clk),                           //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mysystem_lab2_2_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (sys_clk_sys_clk_clk),                                                 //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mysystem_lab2_2_mm_interconnect_1_rsp_mux rsp_mux_001 (
		.clk                 (sys_clk_sys_clk_clk),                                                 //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mysystem_lab2_2_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
